...
\begin{calendar}{\textwidth} % Calendar to be the entire width of the page
	...
	\day{}{\vspace{2.5cm}} % 16
	\day{Proyecto Upbeat}{\dayheader{Back: lógica para crear cantantes y subir canciones.}}{} % 17
	\day{Proyecto Upbeat}{\dayheader{Web y móvil: vistas para crear cantantes y subir canciones.}}{} % 18
	\day{}{\vspace{2.5cm}} % 19
